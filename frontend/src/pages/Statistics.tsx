...
const categories: Record<Category, UiKey> = {resources: 'stats.category.resources', delta: 'stats.category.delta', action: 'stats.category.action', opsi: 'stats.category.opsi', commission: 'stats.category.commission', ships: 'stats.category.ships', loot: 'stats.category.loot'}
